...
import com.wallet.entities.BitcoinCashCoinType
import com.wallet.entities.FeePriceScale
import com.wallet.modules.settings.appearance.PriceChangeInterval
...
val Token.iconPlaceholder: Int
    get() = when (type) {
        ...
        is TokenType.Bep2 -> com.icons.R.drawable.bep2
        else -> com.icons.R.drawable.coin_placeholder
    }
...
val BlockchainType.tokenIconPlaceholder: Int
    get() = when (this) {
        BlockchainType.Ethereum -> com.icons.R.drawable.erc20
        BlockchainType.BinanceSmartChain -> com.icons.R.drawable.bep20
        BlockchainType.BinanceChain -> com.icons.R.drawable.bep2
        BlockchainType.Avalanche -> com.icons.R.drawable.avalanche_erc20
        BlockchainType.Polygon -> com.icons.R.drawable.polygon_erc20
        BlockchainType.Optimism -> com.icons.R.drawable.optimism_erc20
        BlockchainType.ArbitrumOne -> com.icons.R.drawable.arbitrum_erc20
...
val Coin.imagePlaceholder: Int
    get() = com.icons.R.drawable.coin_placeholder
