...
import com.wallet.modules.market.MarketModule.ListType
...
import com.wallet.modules.market.overview.MarketOverviewModule.MarketMetrics
import com.wallet.modules.market.overview.MarketOverviewModule.MarketMetricsPoint
import com.wallet.modules.market.overview.MarketOverviewModule.TopNftCollectionsBoard
import com.wallet.modules.market.overview.MarketOverviewModule.TopPlatformsBoard
import com.wallet.modules.market.overview.MarketOverviewModule.TopSectorsBoard
import com.wallet.modules.market.overview.TopSectorsRepository.Companion.getCategoryMarketData
...
//    }
    ...
    private fun getSectionIcon(type: ListType): Int {
        return when (type) {
            ListType.TopGainers -> com.icons.R.drawable.ic_circle_up_20
            ListType.TopLosers -> com.icons.R.drawable.ic_circle_down_20
        }
    }
