...
import com.wallet.modules.send.bitcoin.advanced.BtcTransactionInputSortInfoScreen
import com.wallet.modules.send.bitcoin.advanced.FeeRateCaution
import com.wallet.modules.send.bitcoin.advanced.SendBtcAdvancedSettingsScreen
import com.wallet.modules.send.bitcoin.utxoexpert.UtxoExpertModeScreen
...
fun UtxoCell(
    ...
    RowUniversal(
        ...
        when (utxoData.type) {
            ...
            null -> {
                Icon(
                    painter = painterResource(com.icons.R.drawable.ic_arrow_right),
                    contentDescription = null,
                    tint = ComposeAppTheme.colors.grey
                )
            }
