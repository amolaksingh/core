...
import com.wallet.modules.main.MainActivity
import com.wallet.R
...
object MainModule {
    ...
    enum class MainNavigation(val iconRes: Int, val titleRes: Int) : Parcelable {
        Market(com.icons.R.drawable.ic_market_24, R.string.Market_Title),
        Balance(com.icons.R.drawable.ic_wallet_24, R.string.Balance_Title),
        Transactions(com.icons.R.drawable.ic_transactions, R.string.Transactions_Title),
        Settings(com.icons.R.drawable.ic_settings, R.string.Settings_Title);
