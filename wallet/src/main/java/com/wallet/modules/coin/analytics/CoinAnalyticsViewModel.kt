package com.wallet.modules.coin.analytics
...
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.ActionType
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticChart
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticInfo
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticsViewItem
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.BlockViewItem
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.IconTitle
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.OverallScoreValue
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.Title
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.TitleWithInfo
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.Value
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.ChartViewItem
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.FooterType.FooterItem
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.PreviewBlockViewItem
import com.wallet.modules.coin.analytics.CoinAnalyticsModule.PreviewChartType
...
import com.wallet.modules.coin.audits.CoinAuditsModule
import com.wallet.modules.coin.detectors.IssueItemParcelable
import com.wallet.modules.coin.detectors.IssueParcelable
import com.wallet.modules.market.ImageSource
import com.wallet.modules.metricchart.ProChartModule
import com.wallet.ui.compose.TranslatableString
import com.wallet.ui.compose.TranslatableString.ResString
...
class CoinAnalyticsViewModel(
    ...
    private fun getViewItems(analytics: Analytics): List<BlockViewItem> {
                        ...
                        FooterItem(
                            title = IconTitle(
                                ImageSource.Remote(
                                    ...
                                    com.icons.R.drawable.coin_placeholder
                                ),
        ...
        analytics.issues?.let { issues ->
            ...
            sortedList.forEach { blockchainAndIssues ->
                ...
                val icon =
                    ImageSource.Remote(blockchain.type.imageUrl, com.icons.R.drawable.coin_placeholder)
    ...
    private fun getChartViewItem(
        ...
        val points = values.map { com.chartview.models.ChartPoint(it.value.toFloat(), it.timestamp)
        }
