...
import com.wallet.modules.coin.overview.CoinOverviewItem
import com.wallet.modules.coin.overview.CoinOverviewViewItem
...
class CoinViewFactory(
    ...
    private fun getIcon(linkType: LinkType): Int {
        return when (linkType) {
            LinkType.Guide -> com.icons.R.drawable.ic_academy_20
            LinkType.Website -> R.drawable.ic_globe_20
            LinkType.Whitepaper -> R.drawable.ic_clipboard_20
            LinkType.Twitter -> com.icons.R.drawable.ic_twitter_20
            LinkType.Telegram -> com.icons.R.drawable.ic_telegram_20
            LinkType.Reddit -> com.icons.R.drawable.ic_reddit_20
