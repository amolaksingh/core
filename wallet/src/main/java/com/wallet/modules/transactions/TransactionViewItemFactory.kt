...
import com.wallet.core.adapters.TonTransactionRecord.Type.Incoming
import com.wallet.core.adapters.TonTransactionRecord.Type.Outgoing
import com.wallet.core.adapters.TonTransactionRecord.Type.Unknown
...
class TransactionViewItemFactory(
    ...
    private fun doubleValueIconType(
        ...
        if (primaryValue != null) {
            ...
            frontRectangle = false
            frontUrl = null
            frontPlaceHolder = com.icons.R.drawable.coin_placeholder
        }
        ...
        if (secondaryValue != null) {
            ...
            backRectangle = false
            backUrl = null
            backPlaceHolder = com.icons.R.drawable.coin_placeholder
        }
