package com.wallet.modules.manageaccount
...
import com.wallet.modules.balance.ui.NoteError
import com.wallet.modules.balance.ui.NoteWarning
import com.wallet.modules.manageaccount.ManageAccountModule.BackupItem
import com.wallet.modules.manageaccount.ManageAccountModule.KeyAction
            ...
            KeyAction.PrivateKeys -> {
                actionItems.add {
                    AccountActionItem(
                        ...
                        icon = painterResource(id = com.icons.R.drawable.ic_key_20)
                    ) {
                        navController.slideFromRight(
