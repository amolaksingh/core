...
import com.wallet.R
import com.wallet.ui.helpers.LayoutHelper
            ...
            override fun configureSpansFactory(builder: MarkwonSpansFactory.Builder) {
                builder.setFactory(Heading::class.java) { _, props: RenderProps ->
                    ...
                    if (level == 1) {
                        arrayOf(
                            ...
                            ForegroundColorSpan(context.getColor(com.core.R.color.leah))
                        )
                    } else {
                        arrayOf(
                ...
                builder.setFactory(Paragraph::class.java) { _, _ ->
                    arrayOf(
                        ...
                        ForegroundColorSpan(context.getColor(com.core.R.color.grey))
                    )
                }
            }
        })
